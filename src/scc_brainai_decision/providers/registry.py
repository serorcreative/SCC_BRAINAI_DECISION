"""Registre des fournisseurs de décision — repli déterministe garanti."""
...
from scc_brainai_decision.providers.external import KNOWN_EXTERNAL


class ProviderRegistry:
    def __init__(self) -> None:
        self._providers: Dict[str, BaseProvider] = {}
        self.register(DeterministicDecider())
